# -*- coding: utf-8 -*-
"""
Created on Fri Apr 24 14:41:42 2026
...
adata = sc.read_10x_h5('GSM8594562_P3NAT_filtered_feature_bc_matrix.h5')

spatial_data = pd.read_csv('GSM8594562_P3NAT_tissue_positions.csv')
...
# Load the JSON file
with open('GSM8594562_P3NAT_scalefactors_json.json', 'r') as f:
...
adata.write("GSM8594562_processed.h5ad")
